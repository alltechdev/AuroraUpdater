...
object Preferences {
    ...
    const val PREFERENCE_BLACKLIST_PASSWORD = "PREFERENCE_BLACKLIST_PASSWORD"
    const val PREFERENCE_REMOTE_BLACKLIST_URL = "PREFERENCE_REMOTE_BLACKLIST_URL"
    const val PREFERENCE_REMOTE_BLACKLIST_ENABLED = "PREFERENCE_REMOTE_BLACKLIST_ENABLED"
    const val PREFERENCE_REMOTE_BLACKLIST_LAST_UPDATE = "PREFERENCE_REMOTE_BLACKLIST_LAST_UPDATE"
